...
public class Tables {
    ...
    public static void main(String args[]) {
        try {
            ...
            //st.executeUpdate("insert into appuser (userRole,name,dob,mobileNumber,email,username,password,address) values('Admin','Admin','02-02-1994','0171111111','admin@gmail.com','admin','admin','Bangladesh')");
            //st.executeUpdate("create table medicine(medicine_pk int AUTO_INCREMENT primary key,medType varchar(200),uniqueID varchar(200),name varchar(200),companyName varchar(200),qunatity bigint,price bigint)");

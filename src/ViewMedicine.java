...
public class ViewMedicine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(267, 6, 280, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(819, 6, -1, -1));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 56, 851, 10));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Medicine Type", "Medicine ID", "Name", "Company Name", "Quantity", "Price"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 839, 360));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel2.setText("Select the User whome you want to remove then Click on the Delete Button ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 440, 560, -1));
        ...
        // TODO add your handling code here:
         ...
         try{
            Connection con=ConnectionProvider.getCon();
                ...
                while(rs.next()){
                model.addRow(new Object[]{rs.getString("medicine_pk"),rs.getString("medType"),rs.getString("uniqueId"),rs.getString("name"),rs.getString("companyName"),rs.getString("Qunatity"),rs.getString("Price")});
           }
